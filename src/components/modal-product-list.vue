...
defineProps(["name", "codename", "list"]);
defineEmits([]);
</script>
...
<template>
	<div
		...
		:class="{
			hidden: modals.openedModal !== codename,
	...
	>
		<div id="modal-cart" class="modal-content" @click.stop="">
			...
			<ul
				...
				v-if="modals.openedModal === codename"
			>
				<li
				...
				>
					...
					<div class="product-card-in-list__info__quantity">
						<button class="product-card-in-list__info__quantity__reduce-btn">
							-
						</button>
						<input type="number" value="1" min="1" max="999" class="amount" />
						<button class="product-card-in-list__info__quantity__add-btn">
							+
						</button>
					</div>
				</li>
