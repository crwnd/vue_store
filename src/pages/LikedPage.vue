...
<template>
  <div id="liked-content">
    <h1 id="component-content-heading">Liked</h1>
    <ul
      id="modal-cart__content__categories-list"
      class="modal-content__shows-on-unempty"
      v-if="products.likedList.length > 0"
    >
      <li
        v-for="product in products.likedProducts"
    ...
    >
      ...
      <span>You haven't added to liked any products yet</span>
      <a href="/">
