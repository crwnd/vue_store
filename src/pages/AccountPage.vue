...
async function LogOutWithRedirect() {
	try {
		await user.LogOut();
		console.log(await router.push("/login/"));
	} catch (e) {
	...
	<div id="account-content">
		<aside>
			<ul id="account-section-tabs">
						...
						<div class="account-section-tab__content">
							<div class="account-section-tab__content__left">
								<div class="svg-holder">
									<div class="onactive">
										<component
											v-bind:is="tabItem.svg_active"
										></component>
									</div>
									<div class="nonactive">
										<component
											v-bind:is="tabItem.svg"
										></component>
									</div>
								</div>
							...
							<div
								class="account-section-tab__content__right"
							></div>
						</div>
					</RouterLink>
				</li>
				...
				<li class="account-section-tab" @click="LogOutWithRedirect">
					<a>
						<div class="account-section-tab__content">
							<div class="account-section-tab__content__left">
								<div class="svg-holder">
