			...
			<aside id="filters" class="hidden modalable">
				<div id="filters-content">
					<form
						...
						action="/catalog/"
						@change="formChange"
						@submit.prevent="formChange"
						@reset="formReset"
					>
						<div
							id="filters-content__header"
							class="modal-content__header"
						>
							<h2>Filters</h2>
							<button
								class="close-filters modal-content__header__close close-modal"
								type="button"
							>
								<svg>
									<use
										xlink:href="/svgs/icons.svg?1659470833#close-outline"
									></use>
								</svg>
							</button>
							<!-- <input
						...
						>
							...
							<span
								...
								v-for="(filterValueElem, index) in filterValue"
								@click="
									{
						...
						<div
							class="filter-group"
							v-if="subcategoryObj"
							v-for="filterGroup in subcategoryObj.filters"
							:data-id="filterGroup.id"
						>
							<span>{{ filterGroup.name }}</span>
							<details
								class="filter"
								v-for="filterObj in filterGroup.content"
								:data-id="filterObj.id"
							>
								<summary class="filter__name">
									...
									<div class="filter__name__chevron">
										<svg>
											<use
												xlink:href="/svgs/icons.svg?1659470833#chevron-down"
											></use>
										</svg>
									</div>
								</summary>
						...
						<div class="filters-btns modal-content__bottom-sticky">
							...
							<button
								id="filters-btns__apply"
								class="smallerOnHover"
								type="submit"
							>
								Apply
							</button>
			...
			<main>
				<ul id="subcategory__goods" v-if="filteredProducts">
					<li
						...
						class="subcategory__good product-card"
					>
						<div class="subcategory__good__content">
							...
							<div class="product-card-actions">
								...
								<button class="">
									<svg>
										<use
											xlink:href="/svgs/icons.svg?1659470833#compare-outline"
										></use>
									</svg>
								</button>
							</div>
							...
							>
								<img
									v-for="image in products.getProductByID(
										product.id
							...
							<div
								class="subcategory__good__qos"
								v-if="product.qos.content.length > 0"
							>
								<RouterLink
									v-if="product.qos.type != 'color'"
									v-for="qo in product.qos.content"
									:to="
										'/product/' +
										product.id +
										'/' +
										...
										'/'
									"
									class="subcategory__good__qo"
									><svg>
										<use
											xlink:href="/svgs/icons.svg?1659470833#checkmark-outline"
										></use>
									</svg>
									<span>{{ qo.value }}</span>
								</RouterLink>
								<RouterLink
									...
									:to="
										...
										'/'
									"
									class="subcategory__good__qo color"
									:style="{ 'background-color': qo.value }"
									><svg>
										<use
											xlink:href="/svgs/icons.svg?1659470833#checkmark-outline"
										></use>
							...
							<a
								class="subcategory__good__info__name"
								href="/product/0/?bundle=0"
							>
								<span>{{
									products.getProductByID(product.id)
										.isLoading === false
							...
							<a
								class="reviews_small"
								href="../product/1/reviews"
								title="Reviews"
							>
								<div class="reviews_small__stars">
									<svg>
										<use
											xlink:href="/svgs/icons.svg?1659470833#star-filled"
										></use>
									</svg>
									<svg>
										<use
